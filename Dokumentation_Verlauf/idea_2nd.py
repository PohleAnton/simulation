...
"""
Das waren 1. Schritte - dazu gehört zunächst auch ein bisschen Anfreunden mit Python.
Außerdem wurden Experimente angestellte, wodurch überhaupt interessante Gespräche zustande kommmen - ohne dabei
allzu viele Tokens zu generieren
"""
