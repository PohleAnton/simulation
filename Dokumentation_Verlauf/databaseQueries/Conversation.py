"""
rudimentäre Nutzung der Funktion Calls zu Beziehungen zw. Agents. Wäre Zeit, um Beziehung gründlich in das Projekt einzuarbeiten, wäre dies sicher
nicht unwesentlich
"""
...
from Dokumentation_Verlauf.Database.Database import Database  # Import the Database class
import openai
import yaml
import os
